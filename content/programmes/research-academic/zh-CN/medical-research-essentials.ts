      ...
      items: [
        {
          ...
          description: "医学研究定义与价值；四大类型解析（基础研究侧重机制探索，临床研究聚焦疗效验证）；研究周期模型",
        },
        {
          title: "2. 研究问题构建与文献综述实战",
          description: "识别研究空白；PICO 框架；文献综述方法；数据库使用（PubMed、中国知网等）",
        },
        {
          title: "3. 研究设计与方法学精要",
          description: "定量与定性研究；常见研究设计（随机对照试验、队列研究、病例对照研究、横断面研究）；抽样与变量设计",
        },
        {
          title: "4. 伦理合规与科研管理",
          description: "知情同意；伦理委员会审核流程、伦理申报材料准备与答辩技巧；人体研究规范；数据隐私保护",
        },
        {
          title: "5. 数据收集 & 分析全教程",
          description: "数据收集工具；统计学基础、SPSS/Excel 入门；图表解读",
        },
        {
          title: "6. 国际期刊论文读写精修",
          description: "IMRAD 结构深度解析（如何写出吸引编辑的引言）；摘要撰写；英语常用表达、讨论部分常用句式库；论文批判性阅读；研究海报与展示技巧",
        },
      ],
    },
  ],
